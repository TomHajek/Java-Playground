package dev.playground.grpc.server.intercetor;
...
/**
 * This interceptor is extracting api key from request metadata to verify it to authenticate the request
 */
...
public class ApiKeyAuthInterceptor implements ServerInterceptor {
    ...
    public <ReqT, RespT> ServerCall.Listener<ReqT> interceptCall(ServerCall<ReqT, RespT> serverCall,
        ...
        if (Objects.nonNull(apiKey) && apiKey.equals("playground")) {
